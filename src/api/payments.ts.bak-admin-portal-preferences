...
export async function listPayments(customerId:number,orderId:number,page=1){return (await http.get<Paged<Payment>>(`/customers/${customerId}/orders/${orderId}/payments?page=${page}&per_page=25`)).data}
